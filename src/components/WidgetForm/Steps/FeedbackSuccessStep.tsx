...
interface IFeedbackSuccessStepProps {
  onFeedbackRestartEequested: () => void;
}

export function FeedbackSuccessStep({
  onFeedbackRestartEequested,
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px] min-h-60">
        <svg
          width="40"
          height="40"
          viewBox="0 0 40 40"
        ...
        <button
          onClick={onFeedbackRestartEequested}
          type="button"
          className="py-2 px-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 transition-colors 
            focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500
            disabled:opacity-50 disabled:hover:bg-brand-500 mt-4"
        >
          Quero enviar outro
        </button>
      </div>
